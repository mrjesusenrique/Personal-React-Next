  ...
  return (
    <article className={styles.contenedorParrafoLaboral}>
      ...
      <p className={styles.parrafoLaboral}>
        ...
        Aliquid iste molestias libero aut. Iusto quis modi aliquam inventore ab
        maiores molestias facere impedit. Odio neque est in? Quidem, voluptates
        placeat. Lorem ipsum dolor, sit amet consectetur adipisicing elit.
        Eveniet perspiciatis rem quo fugiat exercitationem odit laboriosam,
        harum tenetur quam cupiditate deserunt tempore nobis facilis saepe vel
        distinctio illo sed ab!
      </p>
    </article>
  );
};
