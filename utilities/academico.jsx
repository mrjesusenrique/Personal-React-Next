...
const Academico = () => {
  return (
    <p className={styles.parrafo}>
      ...
      2019 decidí comenzar en el mundo del Desarrollo y Programación Web en{" "}
      <Link href="https://www.educacionit.com/">
        <a className={styles.link} target="_blanck">
          EducaciónIT
        </a>
      </Link>{" "}
      donde estuve cursando la carrera de Desarrollador Web Full Stack hasta
      julio de 2021. Actualmente me encuentro cursando el primer cuatrimestre de
      la carrera Tecnicatura Superior en Análisis de Sistemas en{" "}
